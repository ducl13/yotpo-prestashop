		...
		<fieldset id="y-fieldset">
	        ...
	        <div class="y-label">{l s='Select bottom Line location' mod='yotpo'}
	          <select name="yotpo_bottom_line_location">
	            <option value="right_column" {if $yotpo_bottomLineLocation == "right_column"}selected{/if}>Right column</option>
	            <option value="left_column" {if $yotpo_bottomLineLocation == "left_column"}selected{/if}>Left column</option>
	            <option value="other" {if $yotpo_bottomLineLocation == "other"}selected{/if}>Other (click update to see instructions)</option>
	          </select>
	        </div> 
